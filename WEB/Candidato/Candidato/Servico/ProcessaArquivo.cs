...
namespace Candidato.Servico
{
    public class ProcessaArquivo
    {

        public async Task ProcessCsvFilesAsync(string directoryPath)
        {
            ...
            if (csvFiles.Length > 0)
            {
                ...
                await Task.Run(async () =>
                {
                    ...
                    {
                        List<ArquivoPonto> records = await LerArquivoAsync(csvFile);
        ...
        /// 
        private async Task<List<ArquivoPonto>> LerArquivoAsync(string enderecoArquivo)
        {
